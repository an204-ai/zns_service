...
import AdminAppConfigs from './pages/admin/AppConfigs';
import AdminAppDetail from './pages/admin/AppDetail';
...
import CustomerAppInfo from './pages/customer/AppInfo';
  ...
  return (
    <Routes>
      ...
      <Route path="/admin" element={<ProtectedRoute requiredRole="ADMIN"><AdminLayout /></ProtectedRoute>}>
        ...
        <Route path="app-configs" element={<AdminAppConfigs />} />
        <Route path="app-configs/:id" element={<AdminAppDetail />} />
      ...
      <Route path="/customer" element={<ProtectedRoute requiredRole="CUSTOMER"><CustomerLayout /></ProtectedRoute>}>
        ...
        <Route path="api-keys" element={<Navigate to="/customer/app-info" replace />} />
        <Route path="app-info" element={<CustomerAppInfo />} />
