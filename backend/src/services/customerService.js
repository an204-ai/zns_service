    ...
    select: {
      ...
      appConfigs: {
        ...
        select: {
          ...
          apiKeys: {
            where: { userId: id },
            select: { id: true, keyName: true, prefix: true, webhookUrl: true, webhookDlrUrl: true, webhookRatingUrl: true, webhookSecret: true, isActive: true, lastUsedAt: true, createdAt: true },
          },
        },
        orderBy: { createdAt: 'desc' },
      },
